...
const navigation = [
  ...
  { name: 'Units', href: '/dashboard/units', icon: Grid3X3 },
  { name: 'Grid View', href: '/dashboard/grid', icon: Grid3X3 },
  { name: 'Price Lists', href: '/dashboard/prices', icon: DollarSign },
      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <h1 className="text-lg font-semibold text-gray-900">BIM System</h1>
            <button
